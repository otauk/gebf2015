<?php $thisPage="mittagsvorlesungen";?>
<?php include("../../header.php") ?>
			<div class="content">
				<div class="text">
					<h1>Mittagsvorlesungen</h1>
					<p>Forschung.fordert.Interdisziplinarität</p>
					<p>
						<a class="readmore"></a>
					</p>
					...
					<div class="expander">
						<p>
							<span class="bigger"> <a href="eingeladene-vortragende.php#sumfleth">Prof. Dr. Elke Sumfleth</a></span><br/>

<?php $thisPage="workshops";?>
<?php include("../../header.php") ?>
			<div class="content">
				<div class="text">
					<h1>Workshops</h1>
					<p>Einführung in die Arbeit mit den Daten des Nationalen Bildungspanel (NEPS)</p>
					<p>
						<a class="readmore"></a>
					</p>

					<div class="expander">
						<h2>Einführung in die Arbeit mit den Daten des Nationalen Bildungspanel (NEPS)</h2>
						<p>
							<a href="eingeladene-vortragende.php#lipp" class="bigger">Dipl.-Soz. Robert Lipp</a><br/>
							...
							<p>
Ziel des Workshops ist es, die Teilnehmerinnen und Teilnehmern in die Arbeit mit den NEPS-Daten einzuführen und deren vielfältige Analysemöglichkeiten zu veranschaulichen. Zu diesem Zweck werden das komplexe Design und die wesentlichen Inhalte der Studie vorgestellt, die verschiedenen Möglichkeiten des Datenzugangs demonstriert sowie ein Einblick in die verfügbaren Dokumentationsmaterialien gegeben.
							</p>
							</div>
					</div>
					<p><hr /></p>
					<p>Einführung in das Forschungsdatenmanagement</p>
					<p>
						<a class="readmore2"></a>
					</p>

					<div class="expander2">
						<h2>Einführung in das Forschungsdatenmanagement</h2>
						<p>
							<a href="eingeladene-vortragende.php#trixa" class="bigger">Jessica Trixa</a><br/>
